...
{
    public partial class FormHoldem9Max : Form
    {
        ...
        private string[] potsPreFlop = new string[9];
        private string[] potsPreTurn = new string[9];
        private string[] potsPreRiver = new string[9];

        int indexTournamentHand = 0;
        public List<Double> listTournamentHands = new List<double>();

        public FormHoldem9Max()
        {
            InitializeComponent();
        }
        ...
        private void SetTheLastToTalk()
        {
            ...
            {
                listBorders.Add(this.btn7, this.p7);
                ...
                listBorders.Add(this.btn9, this.p9);
                listBorders.Add(this.btn8, this.p8);
            }
            ...
            if (idPlayerUTG.ToString() == this.idPlayer7.Text)
            {
                listBorders.Add(this.btn4, this.p4);
                listBorders.Add(this.btn3, this.p3);
                listBorders.Add(this.btn2, this.p2);
            ...
            if (idPlayerUTG.ToString() == this.idPlayer8.Text)
            {
                listBorders.Add(this.btn5, this.p5);
                listBorders.Add(this.btn4, this.p4);
                listBorders.Add(this.btn3, this.p3);
            ...
            if (idPlayerUTG.ToString() == this.idPlayer9.Text)
            {
                listBorders.Add(this.btn6, this.p6);
                listBorders.Add(this.btn5, this.p5);
                listBorders.Add(this.btn4, this.p4);
        ...
        private void SetBorder(int nextToPlay)
        {
            ...
            this.border7.Visible = this.idPlayer7.Text == actions[nextToPlay].IDPlayer.ToString();
            this.border8.Visible = this.idPlayer8.Text == actions[nextToPlay].IDPlayer.ToString();
            this.border9.Visible = this.idPlayer9.Text == actions[nextToPlay].IDPlayer.ToString();
        }
        ...
        private void UnFoldHand(Actions action)
        {
            ...
            if (this.idPlayer7.Text == action.IDPlayer.ToString())
            {
                this.p7c1.Image = new Bitmap(imageGetter.GetImageResource(cardOne), 31, 44);
                this.p7c2.Image = new Bitmap(imageGetter.GetImageResource(cardTwo), 31, 44);
            }
            if (this.idPlayer8.Text == action.IDPlayer.ToString())
            {
                this.p8c1.Image = new Bitmap(imageGetter.GetImageResource(cardOne), 31, 44);
                this.p8c2.Image = new Bitmap(imageGetter.GetImageResource(cardTwo), 31, 44);
            }
            if (this.idPlayer9.Text == action.IDPlayer.ToString())
            {
                this.p9c1.Image = new Bitmap(imageGetter.GetImageResource(cardOne), 31, 44);
                this.p9c2.Image = new Bitmap(imageGetter.GetImageResource(cardTwo), 31, 44);
            }
        }
        ...
        private void RemoveMoneyFromPot(Actions action)
        {
            ...
            if (this.idPlayer7.Text == action.IDPlayer.ToString())
            {
                whatIsLeft = Convert.ToDouble(this.bet7.Text.Substring(2, this.bet7.Text.Length - 2)) - action.Value;
                if (whatIsLeft > 0)
                    this.bet7.Text = "$ " + whatIsLeft.ToString();
                else
                    this.bet7.Text = "";
            }
            if (this.idPlayer8.Text == action.IDPlayer.ToString())
            {
                whatIsLeft = Convert.ToDouble(this.bet8.Text.Substring(2, this.bet8.Text.Length - 2)) - action.Value;
                if (whatIsLeft > 0)
                    this.bet8.Text = "$ " + whatIsLeft.ToString();
                else
                    this.bet8.Text = "";
            }
            if (this.idPlayer9.Text == action.IDPlayer.ToString())
            {
                whatIsLeft = Convert.ToDouble(this.bet9.Text.Substring(2, this.bet9.Text.Length - 2)) - action.Value;
                if (whatIsLeft > 0)
                    this.bet9.Text = "$ " + whatIsLeft.ToString();
                else
                    this.bet9.Text = "";
            }
        ...
        private void UnTurnFlop()
        {
            ...
            this.bet7.Text = potsPreFlop[6];
            this.bet8.Text = potsPreFlop[7];
            this.bet9.Text = potsPreFlop[8];
        }
        ...
        private void UnTurnTurn()
        {
            ...
            this.bet7.Text = potsPreTurn[6];
            this.bet8.Text = potsPreTurn[7];
            this.bet9.Text = potsPreTurn[8];
        }
        ...
        private void UnTurnRiver()
        {
            ...
            this.bet7.Text = potsPreRiver[6];
            this.bet8.Text = potsPreRiver[7];
            this.bet9.Text = potsPreRiver[8];
        }
        ...
        private void TurnRiver()
        {
            ...
            potsPreRiver[6] = this.bet7.Text;
            potsPreRiver[7] = this.bet8.Text;
            potsPreRiver[8] = this.bet9.Text;
        ...
        private void TurnTurn()
        {
            ...
            potsPreTurn[6] = this.bet7.Text;
            potsPreTurn[7] = this.bet8.Text;
            potsPreTurn[8] = this.bet9.Text;
        ...
        private void TurnFlop()
        {
            ...
            potsPreFlop[6] = this.bet7.Text;
            potsPreFlop[7] = this.bet8.Text;
            potsPreFlop[8] = this.bet9.Text;
        ...
        private void FoldHand(Actions action)
        {
            ...
            if (this.idPlayer7.Text == action.IDPlayer.ToString())
            {
                this.p7c1.Image = new Bitmap(OpenTracker.Properties.Resources.whiteCard, 31, 44);
                this.p7c2.Image = new Bitmap(OpenTracker.Properties.Resources.whiteCard, 31, 44);
            }
            if (this.idPlayer8.Text == action.IDPlayer.ToString())
            {
                this.p8c1.Image = new Bitmap(OpenTracker.Properties.Resources.whiteCard, 31, 44);
                this.p8c2.Image = new Bitmap(OpenTracker.Properties.Resources.whiteCard, 31, 44);
            }
            if (this.idPlayer9.Text == action.IDPlayer.ToString())
            {
                this.p9c1.Image = new Bitmap(OpenTracker.Properties.Resources.whiteCard, 31, 44);
                this.p9c2.Image = new Bitmap(OpenTracker.Properties.Resources.whiteCard, 31, 44);
            }
        }
            ...
            foreach (HandPlayers handPlayers in listHandPlayers)
            {
                switch (handPlayers.Seat)
                {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        this.p7.Text = handPlayers.Nickname + " - $" + handPlayers.InitialStack;
                        break;
                    case 8:
                        this.p8.Text = handPlayers.Nickname + " - $" + handPlayers.InitialStack;
                        break;
                    case 9:
                        this.p9.Text = handPlayers.Nickname + " - $" + handPlayers.InitialStack;
                        break;
                    default:
                        break;
                }
        ...
        private void PutMoneyInPot(Actions action)
        {
            ...
            {
                if (this.bet7.Text != "")
                    PreviousBet = Convert.ToDouble(this.bet7.Text.Substring(2, this.bet7.Text.Length - 2));
                this.bet7.Text = "$ " + (action.Value + PreviousBet).ToString();
            }
            if (this.idPlayer8.Text == action.IDPlayer.ToString())
            {
                if (this.bet8.Text != "")
                    PreviousBet = Convert.ToDouble(this.bet8.Text.Substring(2, this.bet8.Text.Length - 2));
                this.bet8.Text = "$ " + (action.Value + PreviousBet).ToString();
            }
            if (this.idPlayer9.Text == action.IDPlayer.ToString())
            {
                if (this.bet9.Text != "")
                    PreviousBet = Convert.ToDouble(this.bet9.Text.Substring(2, this.bet9.Text.Length - 2));
                this.bet9.Text = "$ " + (action.Value + PreviousBet).ToString();
            }
        ...
        private void PlaceAnte(Actions action)
        {
            listHandPlayers.Where(x => x.IDPlayer == action.IDPlayer).FirstOrDefault().InitialStack = listHandPlayers.Where(x => x.IDPlayer == action.IDPlayer).FirstOrDefault().InitialStack - action.Value;
        ...
        internal void PlaceCard(int seat, string card)
        {
            switch (seat)
            {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    if (this.p7c1.Tag == null)
                    {
                        this.p7c1.Image = new Bitmap(imageGetter.GetImageResource(card), 31, 44);
                        this.p7c1.Tag = card;
                    }
                    else
                    {
                        this.p7c2.Image = new Bitmap(imageGetter.GetImageResource(card), 31, 44);
                        this.p7c2.Tag = card;
                    }
                    break;
                case 8:
                    if (this.p8c1.Tag == null)
                    {
                        this.p8c1.Image = new Bitmap(imageGetter.GetImageResource(card), 31, 44);
                        this.p8c1.Tag = card;
                    }
                    else
                    {
                        this.p8c2.Image = new Bitmap(imageGetter.GetImageResource(card), 31, 44);
                        this.p8c2.Tag = card;
                    }
                    break;
                case 9:
                    if (this.p9c1.Tag == null)
                    {
                        this.p9c1.Image = new Bitmap(imageGetter.GetImageResource(card), 31, 44);
                        this.p9c1.Tag = card;
                    }
                    else
                    {
                        this.p9c2.Image = new Bitmap(imageGetter.GetImageResource(card), 31, 44);
                        this.p9c2.Tag = card;
                    }
                    break;
                default:
        ...
        internal void SetHoleCards()
        {
            ...
            foreach (Cards card in listCards)
            {
                ...
                if (this.idPlayer7.Text != "" && card.IDPlayer == Convert.ToInt32(this.idPlayer7.Text))
                    PlaceCard(7, card.Card);
                if (this.idPlayer8.Text != "" && card.IDPlayer == Convert.ToInt32(this.idPlayer8.Text))
                    PlaceCard(8, card.Card);
                if (this.idPlayer9.Text != "" && card.IDPlayer == Convert.ToInt32(this.idPlayer9.Text))
                    PlaceCard(9, card.Card);
            }
        }
        ...
        internal void SeatPlayers()
        {
            foreach (HandPlayers handPlayers in listHandPlayers)
            {
                switch (handPlayers.Seat)
                {
                    ...
                    case 7:
                        this.p7.Text = handPlayers.Nickname + " - $" + handPlayers.InitialStack;
                        this.idPlayer7.Text = handPlayers.IDPlayer.ToString();
                        this.p7c1.Image = new Bitmap(OpenTracker.Properties.Resources.redCard, 31, 44);
                        this.p7c2.Image = new Bitmap(OpenTracker.Properties.Resources.redCard, 31, 44);
                        break;
                    case 8:
                        this.p8.Text = handPlayers.Nickname + " - $" + handPlayers.InitialStack;
                        this.idPlayer8.Text = handPlayers.IDPlayer.ToString();
                        this.p8c1.Image = new Bitmap(OpenTracker.Properties.Resources.redCard, 31, 44);
                        this.p8c2.Image = new Bitmap(OpenTracker.Properties.Resources.redCard, 31, 44);
                        break;
                    case 9:
                        this.p9.Text = handPlayers.Nickname + " - $" + handPlayers.InitialStack;
                        this.idPlayer9.Text = handPlayers.IDPlayer.ToString();
                        this.p9c1.Image = new Bitmap(OpenTracker.Properties.Resources.redCard, 31, 44);
                        this.p9c2.Image = new Bitmap(OpenTracker.Properties.Resources.redCard, 31, 44);
                        break;
                    default:
                        break;
                }
        ...
        internal void ClearParameters()
        {
            ...
            handMoment = 0;
            potsPreFlop = new string[9];
            potsPreTurn = new string[9];
            potsPreRiver = new string[9];
    }
